...
def get_filters():
    """
    Asks user to specify a city, month, and day to use it for analyzing.
        (str) city=name of the city 
        (str) month=name of the month used in filtring, or "all" to skip a month
        (str) day=name of the day used in filtring, or "all" to skip a month
    """
...
def load_data(city, month, day):
    ...
    Args:
        (str) city=name of the city 
        (str) month=name of the month used in filtring, or "all" to skip month
        (str) day=name of the day used in filtring, or "all" to skup month
    output:
...
def main():
    while True:
        ...
        while restart.lower() not in enter:
            restart = input('Please type Yes or No:\n')
